...
<div id="main-container" class="container-fluid">
    <div class="row">
        <div class="offset-md-1 col-md-6 movie-container">
            ...
            <iframe src="<?= $movie->trailer ?>" width="560" height="315" frameborder="0" allow="accelerometer; autoplay; clipboard; encryted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        ...
        <div class="offset-md-1 col-md-10" id="reviews-container">
            ...
            <!-- Verifica se habilida a review para o usuário ou não -->
