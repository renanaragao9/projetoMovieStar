...
?>
    <div id="main-container" class="container-fluid edit-profile-page">
        <div class="col-md-12">
            <form action="<?= $BASE_URL ?>pages/users/user_process.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control disabled" readonly id="email" name="email" value="<?= $userData->email ?>">
                        </div>
            ...
            <div class="row" id="change-password-container">
                <div class="col-md-4">
                    ...
                    <form action="<?= $BASE_URL ?>pages/users/user_process.php" method="POST">
